...
public bool    OtherExecute   { get => GetBit (0) ;   set => SetBit (0, value) ;  }
public bool    OtherWrite     { get => GetBit (1) ;   set => SetBit (1, value) ;  }
public bool    OtherRead      { get => GetBit (2) ;   set => SetBit (2, value) ;  }
public bool    GroupExecute   { get => GetBit (3) ;   set => SetBit (3, value) ;  }
public bool    GroupWrite     { get => GetBit (4) ;   set => SetBit (4, value) ;  }
public bool    GroupRead      { get => GetBit (5) ;   set => SetBit (5, value) ;  }
public bool    UserExecute    { get => GetBit (6) ;   set => SetBit (6, value) ;  }
public bool    UserWrite      { get => GetBit (7) ;   set => SetBit (7, value) ;  }
public bool    UserRead       { get => GetBit (8) ;   set => SetBit (8, value) ;  }
public bool    Sticky         { get => GetBit (9) ;   set => SetBit (9, value) ;  }
public bool    SetGid         { get => GetBit (10) ;  set => SetBit (10, value) ; }
public bool    SetUid         { get => GetBit (11) ;  set => SetBit (11, value) ; }
...
public string Text
{
     get { return NumericToText (Numeric) ; }
     set { Numeric = TextToNumeric (value) ; }
}
